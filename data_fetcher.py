...
# 重要：A 股交易所"非交易日" = 周末 + 法定节假日 + 节假日调休日（如 12/30 调成工作日）
# 这里只列法定节假日（周末自动排除）
_HOLIDAYS_2026_FALLBACK: set = {
    # 元旦：1/1（周四）~ 1/3（周六），周末跟着歇，所以只 1/1 和 1/2 不是交易日（1/3 周末自然不在）
    "20260101", "20260102",
    # 春节：2/16（周一）~ 2/22（周日），共 7 天连休；2/23（周一）正常开市
    "20260216", "20260217", "20260218", "20260219", "20260220",
    # 清明：4/4（周六）~ 4/6（周一），4/4 周六、4/5 周日自然不上班；4/6（周一）休
    "20260406",
    # 劳动节：5/1（周五）~ 5/5（周二）；5/1 周五、5/4 周一、5/5 周二是新增非交易日
    "20260501", "20260504", "20260505",
    # 端午节：6/19（周五）
    "20260619",
    # 中秋节：9/25（周五）
    "20260925",
    # 国庆节：10/1（周四）~ 10/7（周三）；10/8（周四）正常开市
